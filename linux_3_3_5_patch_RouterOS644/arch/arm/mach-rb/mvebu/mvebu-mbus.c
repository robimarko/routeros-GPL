...
static struct mvebu_mbus_soc_data armada_370_mbus_data = {
	.num_wins            = 20,
...
static struct mvebu_mbus_soc_data armada_xp_mbus_data = {
	.num_wins            = 20,
	.has_mbus_bridge     = true,
	.win_cfg_offset      = armada_370_xp_mbus_win_cfg_offset,
...
static struct mvebu_mbus_soc_data kirkwood_mbus_data = {
	.num_wins            = 8,
...
static struct mvebu_mbus_soc_data dove_mbus_data = {
	.num_wins            = 8,
	.win_cfg_offset      = generic_mbus_win_cfg_offset,
 ...
 * only two of them.
 */
static struct mvebu_mbus_soc_data orion5x_4win_mbus_data = {
	.num_wins            = 8,
	.win_cfg_offset      = generic_mbus_win_cfg_offset,
	.save_cpu_target     = mvebu_mbus_default_save_cpu_target,
	.win_remap_offset    = generic_mbus_win_remap_4_offset,
...
static struct mvebu_mbus_soc_data orion5x_2win_mbus_data = {
	.num_wins            = 8,
	.win_cfg_offset      = generic_mbus_win_cfg_offset,
	.save_cpu_target     = mvebu_mbus_default_save_cpu_target,
...
static struct mvebu_mbus_soc_data mv78xx0_mbus_data = {
	.num_wins            = 14,
...
int __init mvebu_mbus_dt_init(bool is_coherent)
{
	...
	if (!np) {
        ...
        // XXX: matched msys
	mbus_state.soc = &armada_xp_mbus_data;
