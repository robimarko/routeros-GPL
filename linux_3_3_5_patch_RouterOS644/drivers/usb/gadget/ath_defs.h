...
#define ath_reg_rd(_phys)       (*(volatile ath_reg_t *) (_phys))

#define ath_reg_wr_nf(_phys, _val) \
	((*(volatile ath_reg_t *) (_phys)) = (_val))
...
#define ATH_APB_BASE			((unsigned)sys_regs)
...
#define ATH_USB2_RESET				(ATH_RESET_BASE + 0xC4)
