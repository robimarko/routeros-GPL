...
#include <al_hal/al_hal_udma_iofic.h>
#include <al_hal/al_hal_udma_config.h>
#include <al_hal/al_hal_ssm_crc_memcpy.h>
#include <al_hal/al_hal_udma_fast.h>
#include <al_hal/al_hal_udma_debug.h>
#include <al_hal/al_hal_plat_services.h>
...
static inline enum dma_status dma_cookie_status(struct al_dma_chan *chan,
	dma_cookie_t cookie, struct dma_tx_state *state)
{
	dma_cookie_t used, complete;

	used = chan->common.cookie;
